...
#Iterate over founded files and load them in one file in HDFS
# i=0
# while [ $i -lt $len ]
# do
    # cat ${array[i++]} | hdfs dfs -put - $basehdfspath
    # hdfs dfs -appendToFile ${array[i++]} $basehdfspath
    # echo ${array[i++]}
# done

# hdfs dfs -appendToFile ${array[1]} $basehdfspath
